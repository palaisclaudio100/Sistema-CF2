...
export class OrchestrationApi{
  ...
  async worker(principal,operation,args){
    ...
    if(operation==='bot_claim'){strict(args,[]);return this.transport.botClaim(principal);}
    if(operation==='execution_event')return this.transport.executionEvent(principal,args);
