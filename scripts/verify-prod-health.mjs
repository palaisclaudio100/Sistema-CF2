...
const expectedFlags = { production_cutover_enabled: true, external_adapters_enabled: false, role_cutover_enabled: true };
...
if (Object.entries(expectedFlags).some(([flag, expected]) => health.flags?.[flag] !== expected)) throw new Error('CF2_PRODUCTION_FLAGS_UNEXPECTED');
